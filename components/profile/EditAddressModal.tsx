...
interface EditAddressModalProps {
    ...
    onClose: () => void
    onSubmit: (updated: AddressResponse) => void
    loading?: boolean
}

export default function EditAddressModal({ isOpen, address, onClose, onSubmit, loading = false }: EditAddressModalProps) {
            ...
            <div className="w-full max-w-lg bg-white rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="bg-gradient-to-r from-[#8FBC8F] to-[#7CA87C] px-6 py-5 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <h3 className="font-nitti font-bold text-white text-lg tracking-wide">Chỉnh sửa địa chỉ</h3>
                    </div>
                    <button
                        onClick={onClose}
