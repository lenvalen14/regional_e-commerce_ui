      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className={`space-y-6 ${inView ? 'animate-slideInFromLeft' : 'opacity-0'}`}>
            ...
            <h2 className="text-4xl md:text-5xl font-beaululo text-[#2F3E34] leading-tight">
          ...
          <div className={`relative ${inView ? 'animate-slideInFromRight' : 'opacity-0'}`}>
            <div className="grid grid-cols-2 gap-4 h-[500px]">
              {/* Main large image */}
              <div className="col-span-2 row-span-2 bg-gradient-to-br from-[#8FBC8F] to-[#2F3E34] rounded-2xl overflow-hidden group hover:scale-105 transition-transform duration-500">
              ...
              <div className="bg-[#FFD700] rounded-xl opacity-80 animate-pulse" />
              <div className="bg-[#8FBC8F] rounded-xl opacity-60 animate-pulse animation-delay-500" />
            </div>
            
            {/* Floating badge */}
            <div className="absolute -top-4 -right-4 bg-[#FFD700] text-[#2F3E34] px-6 py-3 rounded-full font-bold shadow-lg animate-bounce">
              Từ 2020
            </div>
          </div>
        </div>
